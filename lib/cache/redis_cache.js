...
const redis = new Redis({ host: 'redis-16792.c292.ap-southeast-1-1.ec2.cloud.redislabs.com', port: 16792, password: 'x49mqnAJSRPvsCCZb3hIFh5QAGkwz9ri', db: 0 })
...
export async function setCache(key, data, minutes = 60) {
