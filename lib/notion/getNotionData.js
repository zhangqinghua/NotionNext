...
import { getAllCategories } from './getAllCategories'
// import { getAllCategories } from './getAllCategories'
import { getDataBaseInfoByNotionAPI as getDataBaseInfoByNotionAPI1 } from '../notion1/getNotionData'
 ...
 */
/* eslint-disable no-unused-vars */
async function getPostDetailByNotionAPI({ pageId, from }) {
  return getDataBaseInfoByNotionAPI1({ pageId, from })
}
